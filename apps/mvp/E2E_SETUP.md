...
All development and testing uses **port 3005** only. No dual configuration.
...
This starts Next.js on `http://localhost:3005`
...
- ✅ Single port (3005) for everything
...
**Tests timeout:**
- Ensure `pnpm dev` is running on port 3005
...
**Port conflicts:**
- Kill any process on 3005: `fuser -k 3005/tcp`
