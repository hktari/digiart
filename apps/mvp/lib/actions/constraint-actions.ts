...
export async function createConstraint(formData: FormData) {
  ...
  const rawData = {
    minPages: Number.parseInt(formData.get("minPages") as string),
    maxPages: Number.parseInt(formData.get("maxPages") as string),
    maxCreators: formData.get("maxCreators")
      ? Number.parseInt(formData.get("maxCreators") as string)
      : undefined,
    maxReleases: formData.get("maxReleases")
      ? Number.parseInt(formData.get("maxReleases") as string)
      : undefined,
