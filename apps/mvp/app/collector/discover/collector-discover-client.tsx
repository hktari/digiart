...
type CollectorDiscoverClientProps = {
...
export function CollectorDiscoverClient({
  initialCreators,
  initialReleases,
  tags,
  view,
          ...
          (releases.length === 0 && !isLoadingReleases ? (
            ...
            <>
              <CollectorDiscoverReleasesGrid
                releases={releases}
                cycleId={cycleId}
                initiallySelectedReleaseIds={initiallySelectedReleaseIds}
              />
              <InfiniteScrollSentinel
                isLoadingMore={isLoadingMoreReleases}
                hasMore={hasMoreReleases}
